class ActivitiesController < ApplicationController
  ...
  private
    ...
    def activity_params
      params.expect(activity: [ :customer, :phone, :TV_brand, :TV_size, :model_no, :date_in, :date_out, :starting_price, :final_price, :status, :spare_used, :cost_each, :total_cost, :profit, :remarks, :user_id ])
    end
end
